  ...
  function _WebSocketConnect(instanceId) {
  		...
  		instance.ws.onopen = function() {
  			...
  			if (webSocketState.onOpen)
  				((cb, a1) => getWasmTableEntry(cb)(a1))(webSocketState.onOpen, instanceId);
  		...
  		instance.ws.onmessage = function(ev) {
  			...
  			if (ev.data instanceof ArrayBuffer) {
  				...
  				try {
  					((cb, a1, a2, a3) => getWasmTableEntry(cb)(a1, a2, a3))(webSocketState.onMessage, instanceId, buffer, dataBuffer.length);
  				} finally {
  					_free(buffer);
  				}
  		...
  		instance.ws.onerror = function(ev) {
  			...
  			if (webSocketState.onError) {
  				...
  				try {
  				    ((cb, a1, a2) => getWasmTableEntry(cb)(a1, a2))(webSocketState.onError, instanceId, msgBuffer);
  				} finally {
  					_free(msgBuffer);
  				}
  		...
  		instance.ws.onclose = function(ev) {
  			...
  			if (webSocketState.onClose)
  				((cb, a1, a2) => getWasmTableEntry(cb)(a1, a2))(webSocketState.onClose, instanceId, ev.code);
